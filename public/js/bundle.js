...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3RhbmRldiIsImEiOiJja2FudHE0dHcxaGU0MnRwNjhsZGVsYzh2In0.rXxNy4iNNLe24zyfqxd_gg';
...
var _alerts = _interopRequireWildcard(require("./alerts"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = //hitting an appropiate endpoint depending on 'type' var
            type === 'data' ? 'http://localhost:8000/api/v1/users/updateMe' : 'http://localhost:8000/api/v1/users/updatePassword';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_putBLOOhE09rFQ2Avrh78HsQ00jJV6pdaX');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; //Await is not to save the data, it is to be ready to modify the fields
